...
Aus diesen Daten werden die _Stundenzettel_ generiert und dir zum Download bereitgestellt. Die PDF-Dateien werden nicht gespeichert, sondern bei jedem Export neu erzeugt.
...
Aber natürlich geht es hier um Vertrauen. Du bist jederzeit eingeladen, mit uns direkt ins Gespräch zu kommen: [clock@uni-frankfurt.de](mailto:clock@uni-frankfurt.de).
